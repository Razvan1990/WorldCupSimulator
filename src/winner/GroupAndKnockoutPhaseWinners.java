...
public class GroupAndKnockoutPhaseWinners {
    ...
    public List<List<LinkedHashMap<String, List<Integer>>>> createLast16Teams() throws InterruptedException {
        try {
            /* compute things from groupA*/
            List<List<LinkedHashMap<String, List<Integer>>>> last16ListTeams = new ArrayList<>();
            List<LinkedHashMap<String, List<Integer>>> qualifiedTeams = new ArrayList<>();
            List<LinkedHashMap<String, List<Integer>>> notQualifiedTeams = new ArrayList<>();
            ...
            for (LinkedHashMap<String, List<Integer>> list : last16ListTeams.get(0)) {
    ...
    public List<List<LinkedHashMap<String, List<Integer>>>> getQuarterFinalTeams(List<List<LinkedHashMap<String, List<Integer>>>> last16Teams) throws InterruptedException {
        try {
            List<List<LinkedHashMap<String, List<Integer>>>> quarterFinalsTeams = new ArrayList<>();
            List<LinkedHashMap<String, List<Integer>>> qualifiedTeams = new ArrayList<>();
            List<LinkedHashMap<String, List<Integer>>> nonQualifiedTeams = new ArrayList<>();
            System.out.println("Last 16 results are: ");
            Thread.sleep(1500);
            /*Match1*/
            List<LinkedHashMap<String, List<Integer>>> qualifier1 = scoreGenerator.getQualifiedTeamsFromKnockouts(last16Teams.get(0).get(0), last16Teams.get(0).get(3));
            LinkedHashMap<String, List<Integer>> qualifiedTeam1 = qualifier1.get(0);
            LinkedHashMap<String, List<Integer>> nonQualifiedTeam1 = qualifier1.get(1);
            qualifiedTeams.add(qualifiedTeam1);
            nonQualifiedTeams.add(nonQualifiedTeam1);
            Thread.sleep(1500);
            /*Match2*/
            List<LinkedHashMap<String, List<Integer>>> qualifier2 = scoreGenerator.getQualifiedTeamsFromKnockouts(last16Teams.get(0).get(1), last16Teams.get(0).get(2));
            LinkedHashMap<String, List<Integer>> qualifiedTeam2 = qualifier2.get(0);
            LinkedHashMap<String, List<Integer>> nonQualifiedTeam2 = qualifier2.get(1);
            qualifiedTeams.add(qualifiedTeam2);
            nonQualifiedTeams.add(nonQualifiedTeam2);
            Thread.sleep(1500);
            /*Match3*/
            List<LinkedHashMap<String, List<Integer>>> qualifier3 = scoreGenerator.getQualifiedTeamsFromKnockouts(last16Teams.get(0).get(4), last16Teams.get(0).get(7));
            Thread.sleep(1500);
            LinkedHashMap<String, List<Integer>> qualifiedTeam3 = qualifier3.get(0);
            LinkedHashMap<String, List<Integer>> nonQualifiedTeam3 = qualifier3.get(1);
            qualifiedTeams.add(qualifiedTeam3);
            nonQualifiedTeams.add(nonQualifiedTeam3);
            /*Match4*/
            List<LinkedHashMap<String, List<Integer>>> qualifier4 = scoreGenerator.getQualifiedTeamsFromKnockouts(last16Teams.get(0).get(5), last16Teams.get(0).get(6));
            LinkedHashMap<String, List<Integer>> qualifiedTeam4 = qualifier4.get(0);
            LinkedHashMap<String, List<Integer>> nonQualifiedTeam4 = qualifier4.get(1);
            qualifiedTeams.add(qualifiedTeam4);
            nonQualifiedTeams.add(nonQualifiedTeam4);
            Thread.sleep(1500);
            /*Match5*/
            List<LinkedHashMap<String, List<Integer>>> qualifier5 = scoreGenerator.getQualifiedTeamsFromKnockouts(last16Teams.get(0).get(8), last16Teams.get(0).get(11));
            LinkedHashMap<String, List<Integer>> qualifiedTeam5 = qualifier5.get(0);
            LinkedHashMap<String, List<Integer>> nonQualifiedTeam5 = qualifier5.get(1);
            qualifiedTeams.add(qualifiedTeam5);
            nonQualifiedTeams.add(nonQualifiedTeam5);
            Thread.sleep(1500);
            /*Match6*/
            List<LinkedHashMap<String, List<Integer>>> qualifier6 = scoreGenerator.getQualifiedTeamsFromKnockouts(last16Teams.get(0).get(9), last16Teams.get(0).get(10));
            LinkedHashMap<String, List<Integer>> qualifiedTeam6 = qualifier6.get(0);
            LinkedHashMap<String, List<Integer>> nonQualifiedTeam6 = qualifier6.get(1);
            qualifiedTeams.add(qualifiedTeam6);
            nonQualifiedTeams.add(nonQualifiedTeam6);
            Thread.sleep(1500);
            /*Match7*/
            List<LinkedHashMap<String, List<Integer>>> qualifier7 = scoreGenerator.getQualifiedTeamsFromKnockouts(last16Teams.get(0).get(12), last16Teams.get(0).get(15));
            LinkedHashMap<String, List<Integer>> qualifiedTeam7 = qualifier7.get(0);
            LinkedHashMap<String, List<Integer>> nonQualifiedTeam7 = qualifier7.get(1);
            qualifiedTeams.add(qualifiedTeam7);
            nonQualifiedTeams.add(nonQualifiedTeam7);
            Thread.sleep(1500);
            /*Match8*/
            List<LinkedHashMap<String, List<Integer>>> qualifier8 = scoreGenerator.getQualifiedTeamsFromKnockouts(last16Teams.get(0).get(13), last16Teams.get(0).get(14));
            LinkedHashMap<String, List<Integer>> qualifiedTeam8 = qualifier8.get(0);
            LinkedHashMap<String, List<Integer>> nonQualifiedTeam8 = qualifier8.get(1);
            ...
            for (LinkedHashMap<String, List<Integer>> list : quarterFinalsTeams.get(0)) {
                for (String team : list.keySet()) {
                    System.out.print(team + "\t");
                }
            }
    ...
    public List<List<LinkedHashMap<String, List<Integer>>>> getSemifinalTeams(List<List<LinkedHashMap<String, List<Integer>>>> quarterFinalTeams) throws InterruptedException {
        try {

            List<List<LinkedHashMap<String, List<Integer>>>> semifinalTeams = new ArrayList<>();
            List<LinkedHashMap<String, List<Integer>>> qualifiedTeams = new ArrayList<>();
            List<LinkedHashMap<String, List<Integer>>> nonQualifiedTeams = new ArrayList<>();
            System.out.println("Quarter final results are: ");
            Thread.sleep(1500);
            /*Match1*/
            List<LinkedHashMap<String, List<Integer>>> qualifier1 = scoreGenerator.getQualifiedTeamsFromKnockouts(quarterFinalTeams.get(0).get(0),
            ...
            Thread.sleep(1500);
            /*Match2*/
            List<LinkedHashMap<String, List<Integer>>> qualifier2 = scoreGenerator.getQualifiedTeamsFromKnockouts(quarterFinalTeams.get(0).get(1),
            ...
            Thread.sleep(1500);
            /*Match3*/
            List<LinkedHashMap<String, List<Integer>>> qualifier3 = scoreGenerator.getQualifiedTeamsFromKnockouts(quarterFinalTeams.get(0).get(2),
            ...
            Thread.sleep(1500);
            /*Match4*/
            List<LinkedHashMap<String, List<Integer>>> qualifier4 = scoreGenerator.getQualifiedTeamsFromKnockouts(quarterFinalTeams.get(0).get(5),
            ...
            for (LinkedHashMap<String, List<Integer>> list : semifinalTeams.get(0)) {
                for (String team : list.keySet()) {
                    System.out.print(team + "\t");
                }
            }
    ...
    public List<List<LinkedHashMap<String, List<Integer>>>> concludeFinals(List<List<LinkedHashMap<String, List<Integer>>>> quarterFinalTeams) throws InterruptedException {
        try {
            List<List<LinkedHashMap<String, List<Integer>>>> finalTeams = new ArrayList<>();
            List<LinkedHashMap<String, List<Integer>>> qualifiedTeams = new ArrayList<>();
            List<LinkedHashMap<String, List<Integer>>> nonQualifiedTeams = new ArrayList<>();
            ...
            int index = 0;
            for (LinkedHashMap<String, List<Integer>> l : nonQualifiedTeams) {
            ...
            System.out.print("\nBig final \t");
            index = 0;
            for (LinkedHashMap<String, List<Integer>> l : qualifiedTeams) {
                for (String team : l.keySet()) {
                    if (index < 1) {
                        System.out.print(team + "-");
                        index++;
    ...
    public List<List<LinkedHashMap<String, List<Integer>>>> getWinners(List<List<LinkedHashMap<String, List<Integer>>>> finalTeams) throws InterruptedException {
        try {
            List<List<LinkedHashMap<String, List<Integer>>>> winners = new ArrayList<>();
            List<LinkedHashMap<String, List<Integer>>> qualifiedTeams = new ArrayList<>();
            List<LinkedHashMap<String, List<Integer>>> nonQualifiedTeams = new ArrayList<>();
            System.out.println("\nQatar World Cup 2022 small final result:");
            Thread.sleep(1500);
            List<LinkedHashMap<String, List<Integer>>> smallFinal = scoreGenerator.getQualifiedTeamsFromKnockouts(finalTeams.get(1).get(0),
                    finalTeams.get(1).get(1));
            LinkedHashMap<String, List<Integer>> qualifiedTeam1 = smallFinal.get(0);
            LinkedHashMap<String, List<Integer>> nonQualifiedTeam1 = smallFinal.get(1);
            qualifiedTeams.add(qualifiedTeam1);
            nonQualifiedTeams.add(nonQualifiedTeam1);
            Thread.sleep(1500);
            System.out.println("Qatar World Cup 2022 big final result:");
            Thread.sleep(1500);
            List<LinkedHashMap<String, List<Integer>>> bigFinal = scoreGenerator.getQualifiedTeamsFromKnockouts(finalTeams.get(0).get(0),
                    finalTeams.get(0).get(1));
            LinkedHashMap<String, List<Integer>> qualifiedTeam2 = bigFinal.get(0);
            LinkedHashMap<String, List<Integer>> nonQualifiedTeam2 = bigFinal.get(1);
            qualifiedTeams.add(qualifiedTeam2);
            nonQualifiedTeams.add(nonQualifiedTeam2);
